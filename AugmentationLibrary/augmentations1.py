...
# This could also be a directory name from where you can load the data.
    ...
    def random_shift_scale_rotate (self,image,num_sample):
        for i in range(num_sample):
            random_shift_scale_rotate_dictionary=dict()
    ...
    def random_rotate (self,image,num_sample):
        for i in range(num_sample):
            random_rotate_dict=dict()
    ...
    def random_crop (self,image,num_sample):
        for i in range(num_sample):
            random_crop_dict=dict()
    ...
    def random_scale (self,image,num_sample):
        for i in range(num_sample):
            random_scale_dict=dict()
    ...
    def random_resize (self,image,num_sample):
        for i in range(num_sample):
