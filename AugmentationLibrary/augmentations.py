...
def random_crop(image: np.ndarray):
  #min crop ht=None, max...
    ...
    crop_height=random.uniform(min_crop_height,max_crop_height)
    crop_width=random.uniform(min_crop_width,max_crop_width)
    ...
    h_start=random.uniform(h_start_min,h_start_max)
    w_start=random.uniform(w_start_min,w_start_max)
...
def random_resize(img,interpolation=cv2.INTER_LINEAR):
    ...
    new_height =random.uniform(new_height_min,new_height_max)
    new_width =random.uniform(new_width_min,new_width_max)
...
# This could also be a directory name from where you can load the data.
    ...
    def Blur (self,image,batchsize):
        for i in range(batchsize):
            img=Blur(image)
            transform_type='Blur'
            return img  

    def CLAHE (self,image,batchsize):
        for i in range(batchsize):
            img=CLAHE(image)
    ...
    def ChannelDropout (self,image,batchsize):
        for i in range(batchsize):
    ...
    def ChannelShuffle (self,image,batchsize):
        for i in range(batchsize):
            img=ChannelShuffle(image)
            transform_type='ChannelShuffle'
            return img  
        

    def ColorJitter (self,image,batchsize):
        for i in range(batchsize):
    ...
    def Downscale (self,image,batchsize):
        for i in range(batchsize):
            img=Downscale(image)
    ...
    def Emboss (self,image,batchsize):
        for i in range(batchsize):
            img=Emboss(image)
    ...
    def Equalize (self,image,batchsize):
        for i in range(batchsize):
            img=Equalize(image)
    ...
    def FancyPCA (self,image,batchsize):
        for i in range(batchsize):
            img=FancyPCA(image)
    ...
    def FromFloat (self,image,batchsize):
        for i in range(batchsize):
            img=FromFloat(image)
    ...
    def GaussNoise (self,image,batchsize):
        for i in range(batchsize):
    ...
    def GaussianBlur (self,image,batchsize):
        for i in range(batchsize):
    ...
    def GlassBlur (self,image,batchsize):
        for i in range(batchsize):
            img=GlassBlur(image)
    ...
    def HistogramMatching (self,image,batchsize):
        for i in range(batchsize):
    ...
    def HueSaturationValue (self,image,batchsize):
        for i in range(batchsize):
    ...
    def ISONoise (self,image,batchsize):
        for i in range(batchsize):
            img=ISONoise(image)
    ...
    def ImageCompression (self,image,batchsize):
        for i in range(batchsize):
            img=ImageCompression(image)
            transform_type='ImageCompression'
            return img  
        
    def InvertImg (self,image,batchsize):
        for i in range(batchsize):
            img=InvertImg(image)
    ...
    def MedianBlur (self,image,batchsize):
        for i in range(batchsize):
    ...
    def MotionBlur (self,image,batchsize):
        for i in range(batchsize):
    ...
    def MultiplicativeNoise (self,image,batchsize):
        for i in range(batchsize):
    ...
    def Normalize (self,image,batchsize):
        for i in range(batchsize):
            img=Normalize(image)
    ...
    def PixelDistributionAdaptation (self,image,batchsize):
        for i in range(batchsize):
    ...
    def Posterize (self,image,batchsize):
        for i in range(batchsize):
            img=Posterize(image)
    ...
    def RGBShift (self,image,batchsize):
        for i in range(batchsize):
            img=RGBShift(image)
            transform_type='RGBShift'
            return img  
        
    def Sharpen (self,image,batchsize):
        for i in range(batchsize):
            img=Sharpen(image)
    ...
    def Solarize (self,image,batchsize):
        for i in range(batchsize):
            img=Solarize(image)
    ...
    def Superpixels (self,image,batchsize):
        for i in range(batchsize):
    ...
    def ToFloat (self,image,batchsize):
        for i in range(batchsize):
            img=ToFloat(image)
    ...
    def ToGray (self,image,batchsize):
        for i in range(batchsize):
            img=ToGray(image)
    ...
    def ToSepia (self,image,batchsize):
        for i in range(batchsize):
            img=ToSepia(image)
    ...
    def VerticalFlip (self,image,batchsize):
        for i in range(batchsize):
    ...
    def HorizontalFlip (self,image,batchsize):
        for i in range(batchsize):
    ...
    def Transpose (self,image,batchsize):
        for i in range(batchsize):
            img=Transpose(image)
    ...
    def OpticalDistortion (self,image,batchsize):
        for i in range(batchsize):
    ...
    def GridDistortion (self,image,batchsize):
        for i in range(batchsize):
    ...
    def PadIfNeeded (self,image,batchsize):
        for i in range(batchsize):
    ...
    def JpegCompression (self,image,batchsize):
        for i in range(batchsize):
    ...
    def Cutout (self,image,batchsize):
        for i in range(batchsize):
            img=Cutout(image)
    ...
    def CoarseDropout (self,image,batchsize):
        for i in range(batchsize):
    ...
    def Lambda (self,image,batchsize):
        for i in range(batchsize):
            img=Lambda(image)
    ...
    def MaskDropout (self,image,batchsize):
        for i in range(batchsize):
    ...
    def GridDropout (self,image,batchsize):
        for i in range(batchsize):
    ...
    def TemplateTransform (self,image,batchsize):
        for i in range(batchsize):
    ...
    def RingingOvershoot (self,image,batchsize):
        for i in range(batchsize):
    ...
    def UnsharpMask (self,image,batchsize):
        for i in range(batchsize):
    ...
    def random_shift_scale_rotate (self,image,batchsize):
        for i in range(batchsize):
            random_shift_scale_rotate_dictionary=dict()
    ...
    def random_rotate (self,image,batchsize):
        for i in range(batchsize):
            random_rotate_dict=dict()
    ...
    def random_crop (self,image,batchsize):
        for i in range(batchsize):
            random_crop_dict=dict()
    ...
    def random_scale (self,image,batchsize):
        for i in range(batchsize):
            random_scale_dict=dict()
    ...
    def random_resize (self,image,batchsize):
        for i in range(batchsize):
    ...
    def composing_random_transforms(self,img_in_nparray):
        random_crop_image=an_object.random_crop (img_in_nparray)
        random_scaled_image=an_object.random_scale (random_crop_image,0)
        random_rotated_image=an_object.random_rotate (random_crop_image)
        visualize(random_rotated_image)
        random_shift_scale_rotate_image=an_object.random_shift_scale_rotate (random_rotated_image)
        visualize(random_shift_scale_rotate_image)
        return random_shift_scale_rotate_image

# %% [markdown]
# ### Read Input Image and labels from the User with labels
