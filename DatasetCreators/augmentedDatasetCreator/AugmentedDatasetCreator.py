...
class AugDataCreator():
    ...
    def TransformList(self):
        ...
        lst_train=[]
        text_file_path="/mc2/SaiAbhishek/Improve_Model_Accuracy_using_Aug_Approaches/Single_Static_Augmentation/AugmentationLibrary/AugmentedDatasetCreator/SupportedAugmentation.txt"
