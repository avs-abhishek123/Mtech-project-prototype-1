...
from AugmentationLibrary.AugmentedDatasetCreator.AugmentedDatasetCreator import AugDataCreator 
...
for ubratio in ub_dataset:
    MajorityImage_Dir="/mc2/SaiAbhishek/Improve_Model_Accuracy_using_Aug_Approaches/Single_Static_Augmentation/chest_X_ray_pneumonia/Unbalanced_Dataset/Unbalanced_"+ubratio+"_DecreasedB/train/NORMAL"
    MinorityImage_Dir="/mc2/SaiAbhishek/Improve_Model_Accuracy_using_Aug_Approaches/Single_Static_Augmentation/chest_X_ray_pneumonia/Unbalanced_Dataset/Unbalanced_"+ubratio+"_DecreasedB/train/PNEUMONIA"
    finalMinorityImageDir="/mc2/SaiAbhishek/Improve_Model_Accuracy_using_Aug_Approaches/Single_Static_Augmentation/chest_X_ray_pneumonia/Augmented_Dataset/Augmented_"+ubratio+"_Dataset"
